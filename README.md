...
**Java 17** - Langage de programmation                    **Spring Boot 3.4.5** - Framework d'application  
**Spring Security** - Authentification et autorisation   **Spring Data JPA** - Sauvegarde des données  
**Maven** - Gestion des dépendances                      **Thymeleaf** - Génération de pages web dynamiques  
**MySQL** - Base de données                              **JaCoCo** - Couverture de code Java  
**JUnit** - Outil pour tester le code                    **Lombok** - Simplifie le code en réduisant la répétition  
